...
(function() {
  ...
  ready = function() {
    return $('input#artist_title').on("keyup", function() {
      return $('input#artist_url_alias').val($.transliterate($(this).val()).toLowerCase());
    });
  };
...
(function ($) {
    ...
    $.transliterate = function (string) {
        string = string.replace(/([^a-zа-яё_0-9\s])/gi, '');
...
(function() {
  ...
  ready = function() {
    return $('input#song_title').on("keyup", function() {
      return $('input#song_url_alias').val($.transliterate($(this).val()).toLowerCase());
    });
  };
